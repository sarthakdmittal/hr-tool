...
export default function Login() {
  ...
  const registerForm = useForm({
    defaultValues: { name: '', company_name: '', email: '', password: '' },
  });
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 px-8 py-8">
          ...
          <div className="flex rounded-lg bg-gray-100 p-1 mb-6">
            ...
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-md transition ${
                tab === 'register' ? 'bg-white text-primary-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              Create Account
            </button>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition ${
                      registerForm.formState.errors.name ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition ${
                      registerForm.formState.errors.company_name ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
                    {...registerForm.register('company_name', { required: 'Company name is required' })}
                  />
                </div>
                {registerForm.formState.errors.company_name && (
                  <p className="mt-1 text-xs text-red-600">{registerForm.formState.errors.company_name.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="you@company.com"
                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition ${
                      registerForm.formState.errors.email ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition ${
                      registerForm.formState.errors.password ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
